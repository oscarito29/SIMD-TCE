...
def monitoreo():
    ...
    # 🔹 Pacientes asignados al médico (según campo medico_responsable)
    cur.execute("""
    ...
    # 🔹 IA: Generar alertas solo de pacientes del médico
    modelo_info = cargar_modelo()
    alertas = []

    for p in pacientes:
        # 🔸 Aquí puedes adaptar los datos que usas en la predicción IA
        datos_paciente = {
            "tipo_lesion": "Contusión",
            "mecanismo_lesion": "Accidente vehicular",
            "escala_glasgow_ingreso": 10,
            "tac_inicial": "Hemorragia",
